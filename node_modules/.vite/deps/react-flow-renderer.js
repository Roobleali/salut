    ...
    if (d3Selection && d3Zoom) {
      return {
        ...
        setViewport: function setViewport2(transform2, options) {
          ...
          var nextTransform = identity.translate((_transform$x = transform2.x) !== null && _transform$x !== void 0 ? _transform$x : x, (_transform$y = transform2.y) !== null && _transform$y !== void 0 ? _transform$y : y).scale((_transform$zoom = transform2.zoom) !== null && _transform$zoom !== void 0 ? _transform$zoom : zoom);
        ...
        fitBounds: function fitBounds2(bounds, options) {
          ...
          var transform2 = identity.translate(x, y).scale(zoom);
          d3Zoom.transform(getD3Transition(d3Selection, options === null || options === void 0 ? void 0 : options.duration), transform2);
        },
